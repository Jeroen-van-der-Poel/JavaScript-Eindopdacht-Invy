...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _Grid_GridLayout__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Grid/GridLayout */ \"./Js/Grid/GridLayout.js\");\n/* harmony import */ var _Grid_CreateGrid__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Grid/CreateGrid */ \"./Js/Grid/CreateGrid.js\");\n/* harmony import */ var _Weather_Api_Weather__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Weather/Api_Weather */ \"./Js/Weather/Api_Weather.js\");\n/* harmony import */ var _Products_ShowPrducts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Products/ShowPrducts */ \"./Js/Products/ShowPrducts.js\");\n/* harmony import */ var _Wizard_stepzation__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Wizard/stepzation */ \"./Js/Wizard/stepzation.js\");\n/* harmony import */ var _Regios_Initialize__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./Regios/Initialize */ \"./Js/Regios/Initialize.js\");\n\r\n\r\n\r\n\r\n\r\n\r\n\r\nconst clothingbutton = document.getElementById(\"Clothing\");\r\nconst tierlantinbutton = document.getElementById(\"Tierlantin\");\r\nconst decorationbutton = document.getElementById(\"Decoration\");\r\nlet formStart = document.getElementById(\"StartForm\");\r\nlet formRegion = document.getElementById(\"product_region\");\r\n\r\nclothingbutton.addEventListener('click', clothesClick);\r\ntierlantinbutton.addEventListener('click', tierlantinClick);\r\ndecorationbutton.addEventListener('click', decorationClick);\r\n\r\nconst header = document.getElementById(\"Header\");\r\n\r\nlet currentRegio = null;\r\n\r\n// =========== Page changes ============= //\r\nfunction clothesClick() {\r\n    header.innerHTML = \"Kleding\";\r\n    _Grid_CreateGrid__WEBPACK_IMPORTED_MODULE_1__[\"grid\"].innerHTML = '';\r\n    Object(_Grid_CreateGrid__WEBPACK_IMPORTED_MODULE_1__[\"createGrid\"])(_Regios_Initialize__WEBPACK_IMPORTED_MODULE_5__[\"Regios\"].getRegio(\"clothes\").grid);\r\n    currentRegio = _Regios_Initialize__WEBPACK_IMPORTED_MODULE_5__[\"Regios\"].getRegio(\"clothes\");\r\n    clothingbutton.style.color = \"green\";\r\n    tierlantinbutton.style.color = \"black\";\r\n    decorationbutton.style.color = \"black\";\r\n    formStart.style.color = \"black\";\r\n}\r\n\r\nfunction tierlantinClick() {\r\n    header.innerHTML = \"Tierlantijn\";\r\n    _Grid_CreateGrid__WEBPACK_IMPORTED_MODULE_1__[\"grid\"].innerHTML = '';\r\n    Object(_Grid_CreateGrid__WEBPACK_IMPORTED_MODULE_1__[\"createGrid\"])(_Grid_GridLayout__WEBPACK_IMPORTED_MODULE_0__[\"tierlantingrid\"]);\r\n    clothingbutton.style.color = \"black\";\r\n    tierlantinbutton.style.color = \"green\";\r\n    decorationbutton.style.color = \"black\";\r\n    formStart.style.color = \"black\";\r\n    getProducts(\"tierlantin\");\r\n}\r\n\r\nfunction decorationClick() {\r\n    header.innerHTML = \"Decoratie\";\r\n    _Grid_CreateGrid__WEBPACK_IMPORTED_MODULE_1__[\"grid\"].innerHTML = '';\r\n    Object(_Grid_CreateGrid__WEBPACK_IMPORTED_MODULE_1__[\"createGrid\"])(_Grid_GridLayout__WEBPACK_IMPORTED_MODULE_0__[\"decorationgrid\"]);\r\n    clothingbutton.style.color = \"black\";\r\n    tierlantinbutton.style.color = \"black\";\r\n    decorationbutton.style.color = \"green\";\r\n    formStart.style.color = \"black\";\r\n    getProducts(\"decoration\");\r\n}\r\n\r\n// =========== weather ============= //\r\nlet weatherButton = document.querySelector('.weatherbutton');\r\n\r\nweatherButton.addEventListener('click', WeatherFunction);\r\n\r\nfunction WeatherFunction() {\r\n    Object(_Weather_Api_Weather__WEBPACK_IMPORTED_MODULE_2__[\"ShowWeather\"])();\r\n}\r\n\r\n// =========== show products ============= //\r\nlet productButton = document.getElementById(\"sidebutton\");\r\nproductButton.addEventListener('click', productClick);\r\n\r\nfunction productClick() {\r\n    if(currentRegio != null){\r\n        Object(_Products_ShowPrducts__WEBPACK_IMPORTED_MODULE_3__[\"ShowProducts\"])(currentRegio.items);\r\n        console.log(currentRegio);\r\n    }\r\n}\r\n\r\n// =========== Wizard ============= //\r\nformStart.addEventListener('click', WizardFunction);\r\nformRegion.addEventListener('change', changeDiv);\r\n\r\nfunction changeDiv() {\r\n    let selectboxvalue = document.getElementById('product_region').options.selectedIndex;\r\n    Object(_Wizard_stepzation__WEBPACK_IMPORTED_MODULE_4__[\"showDiv\"])(selectboxvalue);\r\n}\r\n\r\nfunction WizardFunction() {\r\n    Object(_Wizard_stepzation__WEBPACK_IMPORTED_MODULE_4__[\"startForm\"])();\r\n    /*document.getElementById('product_region').addEventListener(\"change\", showDiv(), false);*/\r\n    clothingbutton.style.color = \"black\";\r\n    tierlantinbutton.style.color = \"black\";\r\n    decorationbutton.style.color = \"black\";\r\n    formStart.style.color = \"green\";\r\n}\r\n\r\n// =========== initialize ============= //\r\nfunction Start() {\r\n    header.innerHTML = \"Welkom\";\r\n    _Grid_CreateGrid__WEBPACK_IMPORTED_MODULE_1__[\"grid\"].innerHTML = \"Kies een regio\";\r\n    _Grid_CreateGrid__WEBPACK_IMPORTED_MODULE_1__[\"grid\"].style.textAlign = \"center\";\r\n    _Grid_CreateGrid__WEBPACK_IMPORTED_MODULE_1__[\"grid\"].style.border = \"none\";\r\n\r\n    window.onload = function () {\r\n        if(localStorage.getItem(\"regios\") === null){\r\n            let clothes = new _Regios_Initialize__WEBPACK_IMPORTED_MODULE_5__[\"Warehouse\"](\"clothes\", [], []);\r\n            clothes.grid = _Grid_GridLayout__WEBPACK_IMPORTED_MODULE_0__[\"clothesgrid\"];\r\n            _Regios_Initialize__WEBPACK_IMPORTED_MODULE_5__[\"Regios\"].addRegios(clothes);\r\n        }\r\n        else{\r\n            _Regios_Initialize__WEBPACK_IMPORTED_MODULE_5__[\"Regios\"].getRegios();\r\n        }\r\n    };\r\n}\r\n\r\nStart();\r\n\r\n\n\n//# sourceURL=webpack:///./Js/App.js?");
